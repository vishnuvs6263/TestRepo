...
public class Staff_ManageStaff_Availability_RepeatAlternateMonths extends BaseClass {
	public static Actions actions;
	public static WebDriverWait wait;
	public static Select select;

	@Test
	public void StaffAvailability_RepeatAlternateDays() throws Exception {
		...
		objects.AvailabilityFrequency().clear();
		objects.AvailabilityFrequency().sendKeys("2");
