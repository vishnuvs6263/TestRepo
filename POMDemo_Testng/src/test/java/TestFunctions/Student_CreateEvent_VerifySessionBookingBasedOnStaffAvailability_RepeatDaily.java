...
public class Student_CreateEvent_VerifySessionBookingBasedOnStaffAvailability_RepeatDaily extends BaseClass {
	...
	public void student_createevent_NeverRepeat() throws Exception {
		...
		wait.until(ExpectedConditions.elementToBeClickable(objects.selectSupportDrpDwn()));
